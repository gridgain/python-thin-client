...
class ObjectArrayObject(GridGainDataType, Nullable):
    """
...
class WrappedDataObject(GridGainDataType, Nullable):
    """
...
class CollectionObject(GridGainDataType, Nullable):
    """
...
class Map(GridGainDataType, Nullable):
    """
...
class BinaryObject(GridGainDataType, Nullable):

...
import pygridgain
import pygridgain.utils as ignite_utils
...
class BinaryStream(BinaryStreamBaseMixin):
    ...
    """
    def __init__(self, client: 'pygridgain.Client', buf: Optional[Union[bytes, bytearray, memoryview]] = None):
        """
...
class AioBinaryStream(BinaryStreamBaseMixin):
    ...
    """
    def __init__(self, client: 'pygridgain.AioClient', buf: Optional[Union[bytes, bytearray, memoryview]] = None):
        """

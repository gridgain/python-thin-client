...
from pygridgain.datatypes import Map, Bool, Long, AnyDataArray, AnyDataObject, ByteArray
...
async def cache_get_and_remove_async(
        connection: 'AioConnection', cache_info: CacheInfo, key: Any, key_hint: 'GridGainDataType' = None
) -> 'APIResult':
...
def cache_clear_key(
        connection: 'Connection', cache_info: CacheInfo, key: Any, key_hint: 'GridGainDataType' = None
) -> 'APIResult':
    """
...
def cache_remove_if_equals(connection: 'Connection', cache_info: CacheInfo, key: Any, sample: Any,
                           key_hint: 'GridGainDataType' = None, sample_hint: 'GridGainDataType' = None) -> 'APIResult':
    """
...
def cache_local_peek(
        conn: 'Connection', cache_info: CacheInfo, key: Any, key_hint: 'GridGainDataType' = None,
...
async def cache_local_peek_async(
        conn: 'AioConnection', cache_info: CacheInfo, key: Any, key_hint: 'GridGainDataType' = None,
        peek_modes: Union[int, list, tuple] = None,
) -> 'APIResult':
    """

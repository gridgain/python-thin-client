...
from pygridgain.datatypes.prop_codes import PROP_NAME, PROP_CACHE_MODE
from pygridgain.monitoring import ConnectionEventListener, ConnectionLostEvent, ConnectionClosedEvent, \
...
def __assert_events(nodes, protocol_context):
    ...
    assert 1 <= len([e for e in events if type(e) is ConnectionClosedEvent and e.node_uuid]) <= 2
